     ...
     { !isRootPath && <Menu as="div" className="relative">
            ...
            <div className="h-10 w-10 rounded-full bg-cover bg-no-repeat bg-center flex items-center justify-center">
                <IoPersonCircleSharp className="text-4xl" />
					...
					>
						<MenuItems style = {{zIndex: 19001, "!important" : true}} className="origin-top-right absolute right-0 mt-2 w-48 rounded-sm shadow-md p-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
							<MenuItem>
